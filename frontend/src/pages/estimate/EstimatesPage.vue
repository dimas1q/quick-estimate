<template>
  <div class="px-6 py-8 max-w-6xl mx-auto relative">
    <input type="file" ref="fileInput" accept="application/json" @change="handleFile" class="hidden" />

    <div class="mx-auto flex flex-col items-center space-y-6 w-full max-w-xl">
    ...
    <div class="absolute top-0 right-0 space-y-4 w-80">
