...
<template>
  <button @click="toggleTheme"
    ...
    <Sun
      class="absolute left-1.5 top-1/2 -translate-y-1/2 w-5 h-5 text-yellow-400 transition-opacity duration-200 pointer-events-none"
    ...
    <!-- Бегунок -->
    <span class="absolute left-1 w-6 h-6 rounded-full  transition-all duration-200 bg-gray-200 dark:bg-gray-900"
