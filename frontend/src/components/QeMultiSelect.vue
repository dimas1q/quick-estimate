<template>
  <div ref="root" class="relative">
    <div @click="toggle" class="qe-input w-full flex items-center gap-1 cursor-pointer min-h-[40px]">
      <div v-if="selectedLabels.length" class="flex flex-nowrap overflow-x-auto gap-1 py-1"
      ...
      <ChevronDown class="w-4 h-4 ml-auto text-gray-400 flex-shrink-0" />
    </div>
