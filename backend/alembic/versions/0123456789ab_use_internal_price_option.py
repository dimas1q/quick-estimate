...
def upgrade() -> None:
    op.add_column('estimates', sa.Column('use_internal_price', sa.Boolean(), nullable=False, server_default='1'))
    op.add_column('estimate_templates', sa.Column('use_internal_price', sa.Boolean(), nullable=False, server_default='1'))
